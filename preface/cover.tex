...
Motivated by this, in this paper, we introduce GPSA(a Graph Processing System with Actors), a single-machine graph processing system based on a parallel BSP computation model with actors by considering the compatibility, convenience and fault-tolerant. 
